...
const Header = () => {
    ...
    return (
        <nav className=' bg-slate-500'>
            ...
            <ul className={`md:flex justify-center text-xl font-bold p-4 z-10  md:h-[80px] items-center md:static absolute duration-500 ease-in bg-slate-500 w-full ${open? 'top-12': 'top-[-230px]'}`}>
